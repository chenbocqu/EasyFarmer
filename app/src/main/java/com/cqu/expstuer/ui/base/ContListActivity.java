 ...
 * 通用列表
 */
package com.cqu.expstuer.ui.base;
...
public abstract class ContListActivity<T> extends Activity implements View.OnClickListener, SHSwipeRefreshLayout.SHSOnRefreshListener {
    protected CommonTools myTool;
    CommonAdapter<T> mAdapter;

    SHSwipeRefreshLayout pullToRefreshLayout;

    SHListView pullListView;
    ...
    private void initView() {
        ...
        pullToRefreshLayout = (SHSwipeRefreshLayout) findViewById(R.id.refreshLayout);
        pullListView = (SHListView) findViewById(R.id.listView);
