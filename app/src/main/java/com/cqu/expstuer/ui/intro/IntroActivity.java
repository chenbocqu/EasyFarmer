package com.cqu.expstuer.ui.intro;
...
import com.cqu.expstuer.MainActivity_;
import com.cqu.expstuer.ui.HomeActivity;
...
public class IntroActivity extends AppIntro {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (myTool != null)
            msg = (String) myTool.getParam(String.class);
    ...
    public void onDonePressed(Fragment currentFragment) {
        ...
        switch (msg) {
            case "firstIn":
                myTool.startActivity(HomeActivity.class);
                break;
            case "notFirstIn":
                break;
            default:
