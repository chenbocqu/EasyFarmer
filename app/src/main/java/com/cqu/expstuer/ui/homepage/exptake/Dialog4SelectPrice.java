package com.cqu.expstuer.ui.homepage.exptake;
...
public class Dialog4SelectPrice extends PopupWindow implements OnClickListener {
    ...
    public Dialog4SelectPrice(Activity context, Integer price) {
        super(context);
        ...
        mMenuView = inflater.inflate(R.layout.dialog_select_price, null);
        initView(mMenuView);
