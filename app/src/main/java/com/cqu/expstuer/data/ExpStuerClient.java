...
public class ExpStuerClient extends WebSocketClient {
    ...
    public ExpStuerClient(URI serverURI) {
        super(serverURI);
    }

    public ExpStuerClient(Context mContext, URI serverURI) {
        super(serverURI);
